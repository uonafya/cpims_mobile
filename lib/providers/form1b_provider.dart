...
class Form1bProvider extends ChangeNotifier {
  final HealthFormData _formData = HealthFormData(
      selectedServices: [], selectedDate: DateTime.now(), domainId: '1234');
  ...
  void setFinalFormDataDOE(DateTime dateOfEvent) {
    ...
    _finalServicesFormData.dateOfEvent =
  ...
  void saveForm1bData(HealthFormData healthFormData) {
    ...
    for (MasterServicesFormData masterFormData
        in finalServicesFormData.masterServicesList ?? []) {
  ...
  List<Map<String, dynamic>> generateCriticalEventsDS(
