  ...
  RadioButtonOptions allShouldBeYes(
    ...
    if (members.isEmpty) {
      return RadioButtonOptions.yes;
        ...
        (element) => element != RadioButtonOptions.yes)) {
      return RadioButtonOptions.no;
    } else {
      return RadioButtonOptions.yes;
    }
  }
  // RadioButtonOptions allShouldBeYes(List<RadioButtonOptions?> members, String message) {
  //   debugPrint(members.toString() + message);
  //   // If all the values are yes return RadioButtonOptions.yes, if not return RadioButtonOptions.no
  //   if (members.isEmpty) {
  //     return RadioButtonOptions.yes;
  //   } else if (members.any((element) => element == RadioButtonOptions.no)) {
  //     return RadioButtonOptions.no;
  //   } else if (members.any((element) => element == null)) {
  //     return RadioButtonOptions.yes;
  //   } else {
  //     return RadioButtonOptions.yes;
  //   }
