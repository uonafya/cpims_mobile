  ...
  Widget build(BuildContext context) {
    return Consumer<CparaProvider>(builder: (context, model, _) {
      return Column(children: [
        ...
        Text(
          "Score: ${model.finalScore()} / (9 points)",
          style: const TextStyle(
            fontSize: 20,
        ...
        DataTable(
          ...
          rows: [
            DataRow(cells: [
              ...
              DataCell(Text('${model.healthyBenchmark()}')),
            ]),
            DataRow(cells: [
              const DataCell(Text('Stable')),
              const DataCell(Text('1')),
              DataCell(Text('${model.stableBenchMark()}')),
            ]),
            DataRow(cells: [
              const DataCell(Text('Safe')),
              const DataCell(Text('3')),
              DataCell(Text('${model.safeBenchMark()}')),
            ]),
            DataRow(cells: [
              const DataCell(Text('Schooled')),
              const DataCell(Text('1')),
              DataCell(Text('${model.schooledBenchmark()}')),
            ]),
            DataRow(cells: [
              const DataCell(Text('Total')),
              const DataCell(Text('9')),
              DataCell(Text('${model.finalScore()}')),
            ]),
          ],
        ),
        const SizedBox(
